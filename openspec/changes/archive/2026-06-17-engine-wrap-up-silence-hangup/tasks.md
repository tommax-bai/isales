...
- [x] 6.2 真机/真通话验收：收尾期客户静默后引擎在 `wrap_up_silence_hangup_ms` 内主动挂断、无「你好，还在么？」；transcript `hangup.reason="wrap_up_silence"`，`/calls` 读回不 500 <!-- WAIVED by user 2026-06-17: real-call acceptance skipped; verified at service+code level instead (deployed engine evaluate_silence probe: wrap-up @4s→wait/@6s→hangup phrase=None; schema/model column probes green; 5 unit/integration tests incl. call-215 regression). -->
